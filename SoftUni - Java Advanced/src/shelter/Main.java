...
//Stormy George
// Initialize the repository
        Shelter shelter1 = new Shelter(15);

// Initialize entity
        Animal animal121 = new Animal("Rex", 7, "Sara");
...
// Remove Animal
        ...
        Animal animal11 = new Animal("Bela", 3, "Sia");
        Animal animal21 = new Animal("Stormy", 4, "George");

        shelter.add(animal1);
        shelter.add(animal2);

// Get Oldest Animal
        Animal oldestAnimal1 = shelter.getOldestAnimal();
        System.out.println(oldestAnimal1); // Stormy 4 (George)

// Get Animal
        Animal animal31 = shelter.getAnimal("Bela", "Sia");
        System.out.println(animal31); // Bela 3 (Sia)
