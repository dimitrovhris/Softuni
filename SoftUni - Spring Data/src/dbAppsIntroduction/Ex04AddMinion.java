...
public class Ex04AddMinion {
    private static final String PRINT_VILLAIN_ADD_FORMAT = "Villain %s successfully added to the database.";
    private static final String GET_VILLAIN_BY_NAME = "SELECT id FROM villains WHERE name = ? ";
    private static final String INSERT_INTO_VILLAINS = "INSERT INTO towns(name, evilness_factor) VALUES(?, ?)";
    private static final String EVILNESS_FACTOR = "evil";

    private static final String PRINT_TOWN_ADD_FORMAT = "Town %s successfully added to the database.";
    ...
    public static void main(String[] args) throws SQLException {
        ...
        final String[] minionsInfo = sc.nextLine().split(" ");
       ...
       int villainId = getEntryId(sqlConnection,
                       ...
                       GET_VILLAIN_BY_NAME, INSERT_INTO_VILLAINS,
    ...
    private static int getEntryId (Connection sqlConnection, List<String> arguments, String getQuery, String insertQuery, String printVillainAddFormat) throws SQLException {
        ...
        if (!resultSet.next()) {
            final PreparedStatement insertStatement = sqlConnection.prepareStatement(INSERT_INTO_VILLAINS);
            ...
            insertStatement.setString(2, EVILNESS_FACTOR);
